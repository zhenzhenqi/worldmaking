    ...
    public class DialogueEditor : Editor
    {
        ...
        private void PaintToolbar()
        {
            ...
            if (GUILayout.Button(gcDelete, EditorStyles.toolbarButton) && this.dialogueTree.HasSelection())
            {
                ...
                //
                // this.editorRoot.serializedObject.ApplyModifiedPropertiesWithoutUndo();
                // this.editorRoot.serializedObject.Update();
        ...
        public void MoveItemTo(TreeViewItem draggedItem, TreeViewItem parent, int insertIndex)
        {
            ...
            if (parentDialogueItem != null)
            {
                ...
                spParentDialogueItemChildren.serializedObject.ApplyModifiedPropertiesWithoutUndo();
                ...
                spDraggedDialogueItem.ApplyModifiedPropertiesWithoutUndo();
