namespace GameCreator.Dialogue
{
    ...
    public class DatabaseDialogueEditor : IDatabaseEditor
    {
        ...
        private const string PROP_AUTOFOCUS = "autoFocusFirstChoice";
        ...
        private SerializedProperty spAutofocusChoice;
        ...
        private void OnEnable()
        {
            ...
            this.spAutofocusChoice = serializedObject.FindProperty(PROP_AUTOFOCUS);
        ...
        private void PaintSettings()
        {
            ...
            EditorGUILayout.PropertyField(this.spAutofocusChoice);
